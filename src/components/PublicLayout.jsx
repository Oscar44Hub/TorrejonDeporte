        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-14 gap-2">
          ...
          <div className="hidden lg:flex items-center gap-2 flex-shrink-0">
            {user && user.role === 'admin' &&
              <Link
                to="/admin"
                className="flex items-center gap-2 bg-[hsl(44,95%,55%)]/20 hover:bg-[hsl(44,95%,55%)]/30 text-[hsl(44,60%,35%)] border border-[hsl(44,95%,55%)]/40 rounded-lg px-3 py-1.5 text-sm font-semibold transition-colors whitespace-nowrap">
                Administración
              </Link>
            }
            ...
            {user && user.role !== 'arbitro' ?
              <Link
                to="/mi-panel"
                className="flex items-center gap-2 bg-primary/20 hover:bg-primary/30 text-primary border border-primary/30 rounded-lg px-3 py-1.5 text-sm font-semibold transition-colors whitespace-nowrap">
                Panel delegado
              </Link> : !user &&
              <button
